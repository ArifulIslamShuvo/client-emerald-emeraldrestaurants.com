...
function EditAddressForm({
    ...
    useEffect(() => {
        async function getEmaraldAreas() {
            ...
            // const area = data?.find(ar => ar._id === selectedAddress.area._id )
            // console.log("TCL: getEmaraldAreas -> area", area)
            // setArea(area.name)
    ...
    useEffect(() => {
        if (selectedAddress) {
            setArea(selectedAddress.area.name)
    ...
    async function handleSubmit(e) {
        ...
        const response = await axios.patch(ADDRESSES_API + targetID, addressData, config)
